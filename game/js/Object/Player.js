...
class Player extends Phaser.Group{
  ...
  constructor (game) {
    ...
    this.skills  = {
      q: { name: 'fire ball', lvl: 0, cost: 1, damage: 1, scale: 1 },
      w: { name: 'lightening', lvl: 0, cost: 2, damage: 2, scale: 2 },
      e: { name: 'icy wind', lvl: 0, cost: 3, damage: 3, scale: 3 },
      r: { name: 'drain life', lvl: 0, cost: 4, damage: 4, scale: 4 },
    }
